...
namespace BorderlessGaming.Forms
{
  public partial class MainWindow : Form
  {
    ...
    private void byTheWindowTitleTextToolStripMenuItem_Click(object sender, EventArgs e)
    {
      ...
      Config.Instance.AddFavorite(favorite, () => { lstFavorites.Items.Add(favorite); });
    }
    ...
    private void RefreshFavoritesList(Favorite fav)
    {
      ...
      Config.Instance.AddFavorite(fav, () => { lstFavorites.Items.Add(fav); });
    }
    ...
    private void btnRemoveFavorite_Click(object sender, EventArgs e)
    {
      ...
      Config.Instance.RemoveFavorite(fav, () => { lstFavorites.Items.Remove(fav); });
    }
    ...
    private void adjustWindowBoundsToolStripMenuItem_Click(object sender, EventArgs e)
    {
      ...
      int.TryParse(
        InputText(LanguageManager.Data("adjustWindowBoundsTitle"),
          string.Format(LanguageManager.Data("adjustWindowBoundsPrompt"),
            LanguageManager.Data("adjustWindowBoundsLeft")), fav.OffsetL.ToString()),
        out int favOffsetL);
      int.TryParse(
        InputText(LanguageManager.Data("adjustWindowBoundsTitle"),
          string.Format(LanguageManager.Data("adjustWindowBoundsPrompt"),
            LanguageManager.Data("adjustWindowBoundsRight")), fav.OffsetR.ToString()),
        out int favOffsetR);
      int.TryParse(
        InputText(LanguageManager.Data("adjustWindowBoundsTitle"),
          string.Format(LanguageManager.Data("adjustWindowBoundsPrompt"),
            LanguageManager.Data("adjustWindowBoundsTop")), fav.OffsetT.ToString()),
        out int favOffsetT);
      int.TryParse(
        InputText(LanguageManager.Data("adjustWindowBoundsTitle"),
          string.Format(LanguageManager.Data("adjustWindowBoundsPrompt"),
            LanguageManager.Data("adjustWindowBoundsBottom")), fav.OffsetB.ToString()),
        out int favOffsetB);
...
#pragma warning restore 1690
      ...
      {
        int.TryParse(
          InputText(LanguageManager.Data("setWindowSizeTitle"),
            string.Format(LanguageManager.Data("setWindowSizePixelPrompt"), "X"),
            fav.PositionX.ToString()), out int favPositionX);
        int.TryParse(
          InputText(LanguageManager.Data("setWindowSizeTitle"),
            string.Format(LanguageManager.Data("setWindowSizePixelPrompt"), "Y"),
    ...
    {
      // set the title
      Text = "Borderless Gaming " + Assembly.GetExecutingAssembly().GetName().Version.ToString(3) +
             ((Uac.Elevated) ? " [Administrator]" : "");
